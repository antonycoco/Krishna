...
<head>
    ...
    <title>@yield('title_area','Krishna')</title>
...
<section id="container">
    ...
    <!-- **********************************************************************************************************************************************************
        ...
        *********************************************************************************************************************************************************** -->
    <!--sidebar start-->
   @include('frontView.inc.sidebar_menu')
    <!--sidebar end-->
    <!-- **********************************************************************************************************************************************************
        MAIN CONTENT
        *********************************************************************************************************************************************************** -->
...
<script class="include" type="text/javascript" src="{{ asset('frontEnd') }}/lib/jquery.dcjqaccordion.2.7.js"></script>
...
<script type="text/javascript" src="{{ asset('frontEnd') }}/lib/gritter/js/jquery.gritter.js"></script>
<script type="text/javascript" src="{{ asset('frontEnd') }}/lib/gritter-conf.js"></script>
...
<script type="text/javascript">
    $(document).ready(function() {
        var unique_id = $.gritter.add({
            ...
            title: 'Bienvenue {{ Auth::user()->user }}!',
            // (string | mandatory) the text inside the notification
            text: '{{ Auth::user()->description }}',
            // (string | optional) the image to display on the left
            image: '{{ route('avatarStream')  }}',
