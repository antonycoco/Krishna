@extends('frontView.layouts.master')

@section('title_area','Acceuil')
...
@section('css_js')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontEnd') }}/css/zabuto_calendar.css">
    <link rel="stylesheet" type="text/css" href="{{ asset('frontEnd') }}/lib/gritter/css/jquery.gritter.css" />
...
@section ('main_content')
    <section id="main-content" style="flex-wrap: wrap">
        <section class="wrapper">
            <div class="row">
                ...
                @yield('cropper')
{{--
                @include('frontView.inc.sidebar_right')
--}}
            </div>
                            ...
                            <div class="message-p pn">
                                ...
                                <div class="row">
                                    <div class="col-md-3 centered hidden-sm hidden-xs">
                                        <img src="{{ asset('frontEnd') }}/img/ui-danro.jpg" class="img-circle" width="65">
                                    </div>
                                    <div class="col-md-9">
                                        <p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb">
                            ...
                            <div class="white-panel pn">
                                ...
                                <p><img src="{{ asset('frontEnd') }}/img/ui-zac.jpg" class="img-circle" width="50"></p>
                                <p><b>Zac Snider</b></p>
                                <div class="row">
                                    <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 mb">
                            <div class="product-panel-2 pn">
                                ...
                                <img src="{{ asset('frontEnd') }}/img/product.jpg" width="200" alt="">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 mb">
                            <div class="content-panel pn">
                                <div id="profile-02">
                                    <div class="user">
                                        <img src="{{ asset('frontEnd') }}/img/friends/fr-06.jpg" class="img-circle" width="80">
                                        <h4>DJ SHERMAN</h4>
                                    </div>
                                </div>
