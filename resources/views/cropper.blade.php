                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <a class="btn btn-warning btn-default" data-dismiss="modal" data-toggle="tooltip" title="@lang('Fermer')"
                              >close</a>
                            <form method="POST" action="{{ currentRoute('cropper.sousmettre') }}">
                            {{ csrf_field() }}
                                <a class="btn btn-primary soumettre" id="download"{{-- style="display:none"--}} data-toggle="tooltip"
                                   title="@lang('Soumettre')">Submit</a>
